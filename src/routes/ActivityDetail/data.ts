export const data = {
  cy: {
    toolbarTitle: 'todo-title',
    toolbarCreateBtn: 'todo-add-button',
    toolbarEditBtn: 'todo-title-edit-button',
    toolbarBackBtn: 'todo-back-button',
    ilustrationEmpty: 'todo-empty-state',
    toolbarSortBtn: 'todo-sort-button',
